 ...
 * @author Matheus
 */
public class degustadoresView extends javax.swing.JFrame {

    /** Creates new form categoriaView */
    public degustadoresView() {
        initComponents();
        try {
            readTable();
        } catch (SQLException ex) {
            Logger.getLogger(degustadoresView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void readTable() throws SQLException{
        ...
        DegustadoresDAO desgutadoresabanco = new DegustadoresDAO(conexao);
        for(degustadores p: desgutadoresabanco.selectALL()){
    ...
    public void readDesc(String desc) throws SQLException{
        ...
        Connection conexao = new Conexao().getConnection();
        DegustadoresDAO desgutadoresabanco = new DegustadoresDAO(conexao);
        for(degustadores p: desgutadoresabanco.readDesc(desc)){
            modelo.addRow(new Object[]{
                p.getNome_degust(),
                p.getDt_contrato()
            });
    ...
    private void CADASTRARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CADASTRARActionPerformed
        if(jTextFieldNome.getText().isEmpty() || jTextFieldData.getText().isEmpty() ){
            ...
            degustadores degustadores_tela = new degustadores(nome,data);
        
            try {
                //categoriabanco precisa da conexao com o banco pra inserir
                Connection conexao = new Conexao().getConnection();
                DegustadoresDAO degustadoresbanco = new DegustadoresDAO(conexao);
                boolean existir = degustadoresbanco.validar(degustadores_tela);
                if(existir){
                    JOptionPane.showMessageDialog(null,"Degustador ja cadastrado");
                }
                
                degustadoresbanco.insert(degustadores_tela);
                JOptionPane.showMessageDialog(null,"Degustador cadastrado com sucesso!!!");
                readTable();
    ...
    private void ATUALIZARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ATUALIZARActionPerformed
         if(jTextFieldNome.getText().isEmpty() || jTextFieldData.getText().isEmpty() ){
            ...
            try {
                ...
                degustadoresbanco.update(degustadores_tela);
                JOptionPane.showMessageDialog(null,"Degustador atualizado com sucesso!!!");
                readTable();
                jTextFieldData.setText("");
                jTextFieldNome.setText("");
    ...
    private void DELETARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETARActionPerformed
        ...
        if(jTextFieldNome.getText().isEmpty() || jTextFieldData.getText().isEmpty() ){
            ...
            try {
                ...
                degustadoresbanco.delete(degustadores_tela);
                JOptionPane.showMessageDialog(null,"Degustador removido com sucesso!!!");
                readTable();
                jTextFieldData.setText("");
                jTextFieldNome.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(degustadoresView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new degustadoresView().setVisible(true);
            }
        });
    }
